...
\begin{equation}
    P = \frac{960}{44 + 62 \cdot (8{,}97052) - 6 \cdot (8{,}97052)^2} \approx \$8{,}21217/\text{kg}.
\end{equation}

El precio de la bolsa de 24\,kg resulta:
\begin{equation}
    \boxed{P_{\text{bolsa}} = 8{,}21217 \times 24 \approx \$197{,}09.}
\end{equation}
...
Precio_kg_15 = 960 / (44 + 62 * x15 - 6 * x15**2)
...
\begin{equation}
    \dfrac{921600}{44 + 62x - 6x^2} = \dfrac{960x + 2100}{44x + 31x^2 - 2x^3}
    \label{eq:f5}
\end{equation}

Multiplicando cruzado y agrupando todos los términos en un solo miembro, se obtiene la función cuadrática equivalente:
\begin{equation}
    2x^2 - 31x + 109{,}375 = 0.
\end{equation}
...
\begin{equation}
    \boxed{x_{\text{niv}} = 8{,}47361 \quad \text{(6 c.s.)}}
\end{equation}

La producción de papa ($q$) calculada en este punto es:
\begin{equation}
    q = 44 \cdot 8{,}47361 + 31 \cdot 8{,}47361^2 - 2 \cdot 8{,}47361^3 = 1381{,}857\ \text{kg}.
\end{equation}

Sabiendo que las bolsas comerciales se fraccionan en presentaciones de 24\,kg:
\begin{equation}
    \text{Bolsas} = \frac{1381{,}857}{24} = 57{,}5774
\end{equation}
...
\begin{equation}
    \boxed{\text{Bolsas} = 58\ \text{bolsas}.}
\end{equation}
