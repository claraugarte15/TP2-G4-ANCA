...
\else
\newcommand{\URLColabAlumnoPrimero}{https://colab.research.google.com/drive/1CB6XRVXGplnbesz4sbzeod_X7A_lpsFj?usp=sharing}
\fi
\ifx \AlumnoSegundo \undefined {}
\else
\newcommand{\URLColabAlumnoSegundo}{https://colab.research.google.com/drive/1CB6XRVXGplnbesz4sbzeod_X7A_lpsFj?usp=sharing}
\fi
\ifx \AlumnoTercero \undefined {}
\else
\newcommand{\URLColabAlumnoTercero}{https://colab.research.google.com/drive/1CB6XRVXGplnbesz4sbzeod_X7A_lpsFj?usp=sharing}
\fi
\ifx \AlumnoCuarto \undefined {}
\else
\newcommand{\URLColabAlumnoCuarto}{https://colab.research.google.com/drive/1CB6XRVXGplnbesz4sbzeod_X7A_lpsFj?usp=sharing}
\fi
